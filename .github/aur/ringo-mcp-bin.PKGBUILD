...
pkgname=ringo-mcp-bin
pkgver=__VERSION__
pkgrel=1
pkgdesc="MCP server over stdio exposing ringo SIP agents for LLM-driven telephony"
arch=('x86_64' 'aarch64')
...
provides=('ringo-mcp')
conflicts=('ringo-mcp')
source_x86_64=("ringo-mcp-$pkgver-x86_64.tar.gz::__BASE__/ringo-mcp-__VERSION__-x86_64-unknown-linux-gnu.tar.gz")
source_aarch64=("ringo-mcp-$pkgver-aarch64.tar.gz::__BASE__/ringo-mcp-__VERSION__-aarch64-unknown-linux-gnu.tar.gz")
...
package() {
  ...
  install -Dm755 "$srcdir/ringo-mcp-$pkgver-$_target/ringo-mcp" "$pkgdir/usr/bin/ringo-mcp"
}
