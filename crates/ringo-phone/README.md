...
Part of the [ringo](https://github.com/davidborzek/ringo) workspace; the crate is `ringo-phone`, the binary is `ringo`.
...
> audio verification), see [ringo-flow](../ringo-flow).
