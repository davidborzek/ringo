...
fn generate_bindings() {
    ...
    let mut builder = bindgen::Builder::default()
        ...
        .allowlist_type("ua|call|bevent|audio|account|config|list|le|pl|sip_hdr|sip_msg|sip_taddr|list_apply_h|stream|rtcp_stats")
        ...
        .opaque_type("ua|call|bevent|audio|account|config|stream")
