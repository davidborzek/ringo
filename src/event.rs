...
#[derive(Debug)]
pub enum AppEvent {
    Registering { account: String },
    RegisterOk { account: String },
    RegisterFailed { reason: String },
    CallIncoming { call_id: String, number: String },
    CallOutgoing { call_id: String, number: String },
    CallRinging { call_id: String },
    CallEstablished { call_id: String },
    CallClosed { call_id: String },
    CallOnHold { call_id: String },
    CallResumed { call_id: String },
    TransferOk { info: String },
    TransferFailed { reason: String },
    VoicemailStatus { waiting: bool, new_count: u32 },
    Response { ok: bool, data: String },
    Unknown { class: String, type_: String },
}
...
fn map_event(class: &str, type_: &str, param: String, extra: &Map<String, Value>) -> AppEvent {
    ...
    match t {
        ...
        "CALL_CLOSED" => AppEvent::CallClosed { call_id: call_id() },
